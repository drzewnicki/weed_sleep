...
final_model <- function(x) {
  model <- glm(x ~ factor(SLPWEED) + race_collapsed + factor(SEROSTAT) + factor(SMOKE) + schooling + sleep_aid_collapsed + CESD + factor(AD_use_dichot), data = final_data, family = "gaussian")
